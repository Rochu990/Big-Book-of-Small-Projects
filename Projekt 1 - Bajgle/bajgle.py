...
def main():
    print(
        """Bajgle, logiczna gra na dedukcję.
          
Mam na myślo {}-cyfrową liczbę, w której nie powtarza się żadna z cyfr.
Spróbuj ją odgadnąć. Oto wskazówki:
Gdy mówię:   Oznacza to:
    Piko    Jedna cyfra jest poprawna, ale jest na złej pozycji.
    Fermi   Jedna cyfra jest poprawna i znajduje się na odpowiednim miejscu.
    Bajgle  Żadna cyfra nie jest poprawna

Na przykłąd, jeśli tajna liczba to 248, a Ty podasz liczbę 843,
wskazówka będzie brzmieć Fermi Piko.""".format(
            NUM_DIGITS
        )
    )
    ...
    while True:
        ...
        while numGuesses <= MAX_GUESSES:
            ...
            if numGuesses > MAX_GUESSES:
                ...
                print("Poprawna odpowiedz to: {}.".format(secretNum))
